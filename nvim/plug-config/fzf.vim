...
" 0.8,'yoffset':0.5,'xoffset': 0.5, 'highlight': 'Todo', 'border': 'sharp'  } }
"
...
"
"                              " Make Ripgrep ONLY search file contents and
"                              not filenames
"                              command! -bang -nargs=* Rg
"                                \ call fzf#vim#grep(
"                                  \   'rg --column --line-number --hidden
"                                  --smart-case --no-heading --color=always
"                                  '.shellescape(<q-args>), 1,
"                                    \   <bang>0 ?
"                                    fzf#vim#with_preview({'options':
"                                    '--delimiter : --nth 4..'}, 'up:60%')
"                                      \           :
"                                      fzf#vim#with_preview({'options':
"                                      '--delimiter : --nth 4.. -e'},
"                                      'right:50%', '?'),
